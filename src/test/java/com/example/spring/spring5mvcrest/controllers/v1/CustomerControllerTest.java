...
public class CustomerControllerTest {
    ...
    public void testUpdateCustomer() throws Exception {
        ...
        customerDTO.setFirstName("Nidhi");
        ...
        mockMvc.perform(put("/api/v1/customers/1")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.firstName", equalTo("Nidhi")))
                .andExpect(jsonPath("$.lastName", equalTo("a")))
                .andExpect(jsonPath("$.url", equalTo("/api/v1/customers/1")));
    ...
    public void testPatchCustomer() throws Exception {
        CustomerDTO customerDTO = new CustomerDTO();
        customerDTO.setFirstName("Nidhish");

        CustomerDTO returnDTO = new CustomerDTO();
        returnDTO.setLastName("Puthiyadath");
        returnDTO.setFirstName(customerDTO.getFirstName());
        returnDTO.setCustomerUrl("/api/v1/customers/1");
        ...
        mockMvc.perform(patch("/api/v1/customers/1")
                ...
                .content(new ObjectMapper().writeValueAsString(customerDTO)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.firstName", equalTo("Nidhish")))
                .andExpect(jsonPath("$.lastName", equalTo("Puthiyadath")))
                .andExpect(jsonPath("$.url", equalTo("/api/v1/customers/1")));
